...
function private.mailMonitor(event,arg1)
	if (event == "MAIL_SHOW") then --We cannot use mail show since the GetInboxNumItems() returns 0 till the first "MAIL_INBOX_UPDATE"
		runonce = true
	elseif (event == "MAIL_INBOX_UPDATE") and runonce then
