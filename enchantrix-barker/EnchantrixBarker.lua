...
function Enchantrix_BarkerGetConfig( key )
	return Enchantrix.Settings.GetSetting("barker."..key)
end

function Enchantrix_BarkerSetConfig( key, value )
	Enchantrix.Settings.SetSetting("barker."..key, value)
end
...
function Enchantrix_BarkerOptions_SetDefaults()
	...
	Enchantrix.Settings.SetSetting("barker.profit_margin", nil)
	Enchantrix.Settings.SetSetting("barker.randomize", nil)
	Enchantrix.Settings.SetSetting("barker.lowest_price", nil)
