...
--	AUCT_FRMT_BIDBROKER_DONE = "";
--	AUCT_FRMT_BIDBROKER_HEADER = "";
--	AUCT_FRMT_BIDBROKER_LINE = "";
--	AUCT_FRMT_BIDBROKER_MINBID = "";
--	AUCT_FRMT_BROKER_DONE = "";
--	AUCT_FRMT_BROKER_HEADER = "";
--	AUCT_FRMT_BROKER_LINE = "";
--	AUCT_FRMT_COMPETE_DONE = "";
--	AUCT_FRMT_COMPETE_HEADER = "";
--	AUCT_FRMT_COMPETE_LINE = "";
--	AUCT_FRMT_HSP_LINE = "";
--	AUCT_FRMT_INFO_ALSOSEEN = "";
--	AUCT_FRMT_INFO_AVERAGE = "";
--	AUCT_FRMT_INFO_BIDRATE = "";
--	AUCT_FRMT_INFO_BUY = "";
--	AUCT_FRMT_INFO_BUYMULT = "";
--	AUCT_FRMT_INFO_CLASS = "";
--	AUCT_FRMT_INFO_CLASSUSE = "";
--	AUCT_FRMT_INFO_FORONE = "";
--	AUCT_FRMT_INFO_HISTMED = "";
--	AUCT_FRMT_INFO_NEVER = "";
--	AUCT_FRMT_INFO_SEEN = "";
--	AUCT_FRMT_INFO_SELL = "";
--	AUCT_FRMT_INFO_SELLMULT = "";
--	AUCT_FRMT_INFO_SNAPMED = "";
--	AUCT_FRMT_INFO_STX = "";
--	AUCT_FRMT_INFO_USE = "";
--	AUCT_FRMT_INFO_YOURSTX = "";
--	AUCT_FRMT_LOW_LINE = "";
--	AUCT_FRMT_MEDIAN_LINE = "";
--	AUCT_FRMT_NOAUCT = "";
--	AUCT_FRMT_PCTLESS_DONE = "";
--	AUCT_FRMT_PCTLESS_HEADER = "";
--	AUCT_FRMT_PCTLESS_LINE = "";
...
if GetLocale() == "frFR" then
	...
	AUCT_FRMT_NOAUCT = "Keine Aktionen f\195\188r diesen Gegenstand gefunden: %s";
	...
	AUCT_FRMT_INFO_SNAPMED = "Letzter Scan %d gesehen, Sofortkauf Median:";
	AUCT_FRMT_INFO_YOURSTX = "Ihr %d Stapel: %s min/%s Sofortkauf (%s geboten)";
	AUCT_FRMT_INFO_BIDRATE = "%d%% hatten gebote, %d%% hatten Sofortkauf";
	AUCT_FRMT_INFO_NEVER = "Nie gesehen in einer %s";
	AUCT_FRMT_INFO_ALSOSEEN = "Gesehen %d mal in einer %s";
	AUCT_FRMT_INFO_CLASSUSE = "Klasse: %s genutzt f\195\188r %s";
	AUCT_FRMT_INFO_CLASS = "Klasse: %s";
	AUCT_FRMT_INFO_USE = "Genutzt f\195\188r: %s";
	AUCT_FRMT_INFO_BUY = "Kauf%s bei H\195\164ndler";
	AUCT_FRMT_INFO_SELL = "Verkauf%s bei H\195\164ndler";
