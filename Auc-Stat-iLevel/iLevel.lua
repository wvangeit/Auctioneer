...
function private.SetupConfigGui(gui)
	...
	gui:AddHelp(id, "what ilevel stats",
		"What are ilevel stats?",
		"ilevel stats are the numbers that are generated by the iLevel module "..
	...
	gui:AddHelp(id, "why multiply stack size ilevel",
		...
		"The original Stat-ilevel multiplied by the stack size of the item, "..
		"but some like dealing on a per-item basis.")

	gui:AddControl(id, "Header",     0,    libName.." options")
	gui:AddControl(id, "Note",       0, 1, nil, nil, " ")
	gui:AddControl(id, "Checkbox",   0, 1, "stat.ilevel.enable", "Enable iLevel Stats")
	gui:AddTip(id, "Allow iLevel to gather and return price data")
	gui:AddControl(id, "Note",       0, 1, nil, nil, " ")

	gui:AddControl(id, "Checkbox",   0, 1, "stat.ilevel.tooltip", "Show iLevel stats in the tooltips?")
	gui:AddTip(id, "Toggle display of stats from the iLevel module on or off")
	gui:AddControl(id, "Checkbox",   0, 2, "stat.ilevel.mean", "Display Mean")
	gui:AddTip(id, "Toggle display of 'Mean' calculation in tooltips on or off")
	gui:AddControl(id, "Checkbox",   0, 2, "stat.ilevel.normal", "Display Normalized")
	gui:AddTip(id, "Toggle display of 'Normalized' calculation in tooltips on or off")
	gui:AddControl(id, "Checkbox",   0, 2, "stat.ilevel.stdev", "Display Standard Deviation")
	gui:AddTip(id, "Toggle display of 'Standard Deviation' calculation in tooltips on or off")
	gui:AddControl(id, "Checkbox",   0, 2, "stat.ilevel.confid", "Display Confidence")
	gui:AddTip(id, "Toggle display of 'Confidence' calculation in tooltips on or off")
	gui:AddControl(id, "Note",       0, 1, nil, nil, " ")
	gui:AddControl(id, "Checkbox",   0, 1, "stat.ilevel.quantmul", "Multiply by Stack Size")
