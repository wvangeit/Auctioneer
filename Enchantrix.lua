--[[
	...
	Enchantrix v3.9.0.1272 (Kangaroo)
	$Id: Enchantrix.lua 1194 2006-12-13 08:09:22Z normal $
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Revision: 1194 $")
