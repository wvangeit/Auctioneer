--[[
	...
	Revision: $Id: Auc-Util-AutoMagic.lua 4662 2010-02-12 22:29:16Z Kandoko $
...
function lib.SetupConfigGui(gui)
	...
	private.guiID = id
		...
		gui:AddControl(id, "Checkbox",		0, 4, 	"util.automagic.autosellgrey", _TRANS('AAMU_Interface_AutoSellListItems')) --"Allow AutoMagic to auto-sell grey items in addition to bought for vendor items"
		gui:AddTip(id, _TRANS('AAMU_HelpTooltip_AutoSellListItems')) --'Auto-sell grey level items at the vendor.'
		
		gui:AddControl(id, "Checkbox",		0, 4, 	"util.automagic.autosellgrey", _TRANS('AAMU_Interface_AutoSellReason')) --"Allow AutoMagic to auto-sell grey items in addition to bought for vendor items"
		...
		gui:AddControl(id, "Checkbox",		0, 6, 	"util.automagic.autosellgreynoprompt", _TRANS('AAMU_Interface_AutoSellListNoPrompt')) --"grey level items and items on the sell list will be sold without a prompt"
		gui:AddTip(id, _TRANS('AAMU_HelpTooltip_AutoSellListNoPrompt')) --'Do not prompt to Auto-sell grey level items at the vendor.'
		gui:AddControl(id, "Checkbox",		0, 6, 	"util.automagic.autosellgreynoprompt", _TRANS('AAMU_Interface_AutoSellReasonNoPrompt')) --"grey level items and items on the sell list will be sold without a prompt"
		gui:AddTip(id, _TRANS('AAMU_HelpTooltip_AutoSellReasonNoPrompt')) --'Do not prompt to Auto-sell grey level items at the vendor.'
		gui:AddControl(id, "Checkbox",		0, 6, 	"util.automagic.autosellgreynoprompt", _TRANS('AAMU_Interface_AutoSellBOPNoPrompt')) --"grey level items and items on the sell list will be sold without a prompt"
...
AucAdvanced.RegisterRevision("$URL: http://dev.norganna.org/auctioneer/trunk/Auc-Util-AutoMagic/Auc-Util-AutoMagic.lua $", "$Rev: 4662 $")
