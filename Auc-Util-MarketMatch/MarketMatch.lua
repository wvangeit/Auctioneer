...
function lib.GetPrice(hyperlink, faction, realm)
	...
	local marketprice = AucAdvanced.API.GetMarketValue(hyperlink)
	local marketdiff = 0
	local competing = 0
	local matchprice = 0
	local minprice = 0
	...
	return matchprice, marketdiff, competing
end

function lib.GetPriceColumns()
	return "Matching Price", "%from Market", "competing auctions"
end
...
function lib.GetPriceArray(hyperlink, faction, realm)
	...
	array.price = matchprice
	array.seen = competing
	-- This is additional data
	array.marketdiff = marketdiff
