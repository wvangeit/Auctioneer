...
EnchantrixBarkerLocalizations = {
	...
	deDE = {
		...
		["EnchSearchBoarSpeed"]	= "Bewegungsgeschwindigkeitserhöhung und [0-9]+ Ausdauer";
		["EnchSearchCatSwiftness"]	= "Bewegungsgeschwindigkeitserhöhung und [0-9]+ Beweglichkeit";
		...
		["BarkerOptionsItemsPriorityTooltip"]	= "Dieses stellt ein, wie wichtig der Gegenstand im Verhältnis zur Gesamtpriorität für die Werbung ist.";
		...
		["BarkerOptionsOtherTooltip"]	= "Die Prioritätsstufe für Verzauberungen wie z.B. Kürschnern, Bergbau, Reiten etc.";
		...
		["BarkerOptionsRandomFactorTooltip"]	= "Legt die Größe des Zufallsfaktors fest, mit welchem Entzauberungen für die Handelsausrufe ausgewählt werden.";
