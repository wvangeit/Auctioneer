...
function buildCommandMap()
	...
	commandMap = {
		...
		[_BARKLOC('CmdFindBidauct')] = 'bidbroker',
		[_BARKLOC('CmdFindBidauctShort')] = 'bidbroker',
		[_BARKLOC('CmdFindBuyauct')] = 'percentless',
		[_BARKLOC('CmdFindBuyauctShort')] = 'percentless',
		[_BARKLOC('ShowEmbed')] = 'embed',
		[_BARKLOC('ShowCount')] = 'counts',
		[_BARKLOC('ShowTerse')] = 'terse',
